  ...
  public static String upload(String content, boolean copy, boolean open) {
    ...
    try {
      ...
      if (!jsonElement.getAsJsonObject().has("key")) {
        JOptionPane.showMessageDialog(null, json, "Fehler beim Hochladen des Chats",
      ...
      JOptionPane.showMessageDialog(null, ex.getMessage(), "Fehler beim Hochladen des Chats",
          JOptionPane.ERROR_MESSAGE);
      return null;
    }
